...
public class ClearChatCommand extends GDCloudCommand {
	...
	public ClearChatCommand(GoldenDupeCommandRegister register, PaperCommandManager.Bootstrapped<CommandSender> commandManager) {
...
//								Bukkit.broadcast(Component.text("CC#"+i), "goldendupe.staff.clearchat.receive");
							...
							messenger.broadcast(Translations.COMMAND_CHAT_CLEAR_STAFF,
